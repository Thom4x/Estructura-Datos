...
class Nodo:
    def __init__(self, valor: Item, mensaje_id: int):
        self.valor = valor          # Valor del nodo, que es un objeto de la clase Item
        self.mensaje_id = mensaje_id  # Identificador único del mensaje
        self.siguiente = None        # Referencia al siguiente nodo en la cola

# Definimos la clase Cola que representa una cola de mensajes
class Cola:
    def __init__(self):
        self.primero = None           # Referencia al primer nodo en la cola
        self.ultimo = None            # Referencia al último nodo en la cola
        self.contador_id = 1          # Inicializamos un contador de IDs para los mensajes
    ...
    def encolar(self, valor: Item):
        ...
        self.contador_id += 1     # Incrementamos el contador de IDs para el siguiente mensaje
    ...
    def desencolar(self):
        ...
        if self.primero is None:
            self.ultimo = None
        return {"mensaje_id": mensaje_id, "valor": valor}  # Devolvemos el mensaje desencolado como un texto
